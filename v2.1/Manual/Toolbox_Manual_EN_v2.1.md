...
- **Width**: 16 HP  
- **Depth**: 25 mm  
- **Power Consumption**: +12V: 130mA / -12V: 130mA  
...
### v2.1 Update
You can select the type of noise used in the Sample & Hold (S&H) section via the jumper located on the back panel.
- Upper position: White noise (default)
- Lower position: Blue noise (brighter tonal character)
